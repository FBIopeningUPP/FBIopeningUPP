...
user@hardware-lab:~$ cat profile.json
{
  ...
  "designation": "PCB Designer & Hardware Engineer",
  "current_status": "Routing traces, optimizing layouts, and debugging hardware...",
  "expertise": [
    "PCB Layout & Routing",
    "Schematic Capture",
    "Signal Integrity",
...
```bash
user@hardware-lab:~$ ./load_tools.sh --verbose
Loading design suite and embedded stack...
[███████████████████████████████████] 100% Success.
```
...
<p align="left">
  ...
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=c,cpp,python,arduino,raspberrypi,linux&theme=dark" alt="Embedded Stack" />
  </a>
</p>
